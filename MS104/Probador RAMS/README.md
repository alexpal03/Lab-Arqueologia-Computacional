...
1. Conectar el probador de ram en el algún espacio del rack de tarjetas, preferiblemene en el espacio del CPU. Desconectar todas las demás placas, menos la tarjeta RAM
